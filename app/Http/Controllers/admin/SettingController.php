...
class SettingController extends Controller
{
    ...
    public function general(){
        $id = 1;  
        $general_setting = GeneralSetting::find($id);  // go into database and find the GeneralSetting pivoting off of id
    ...
    public function seo(){
        $id = 1;  
        $seo_setting = SeoSetting::find($id);  // go into database and find the GeneralSetting pivoting off of id
