                            ...
                            @error('title')
                                ...
                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputprice" class="form-control form-control-lg @error('price') is-invalid @enderror" type="text" value="{{ old('price') }}" required autocomplete="price"
                            ...
                            @error('lname')
                                ...
                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="imageurl" class="form-control form-control-lg @error('image_url') is-invalid @enderror" type="text" value="{{ old('image_url') }}" autocomplete="name"
