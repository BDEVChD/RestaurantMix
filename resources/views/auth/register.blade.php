        ...
        <div class="card">
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            <input class="form-control form-control-lg @error('name') is-invalid @enderror" type="text" value="{{ old('name') }}" required autocomplete="name"
                            name="name" required="" placeholder="Name" autocomplete="off">   
